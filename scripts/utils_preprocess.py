...
def preprocess_roi(img, device):
    """
    Preprocess ROI image for CNN model
    Converts to grayscale, resizes to 24x24, normalizes, and converts to tensor
    """
    # Avoid crashing if the ROI is not detected properly
